...
urlpatterns = [
    path('admin/', admin.site.urls),     # reactivado — lo necesita usuarios/
    ...
    # Administrador
    path('admin-panel/registro/', admin_views.admin_registro, name='admin_registro'),
    path('admin-panel/eliminar/<int:id>/', admin_views.eliminar_admin, name='eliminar_admin'),
