    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateField(db_column='fechaCompra', default=datetime.datetime.now)),
                ('estado', models.CharField(blank=True, db_column='estado', default='', max_length=50)),
                ('Administrador', models.ForeignKey(db_column='idAdministrador', on_delete=django.db.models.deletion.CASCADE, to='app.administrador')),
                ('Producto', models.ForeignKey(db_column='idProducto', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.producto')),
                ('Proveedor', models.ForeignKey(db_column='idProveedor', on_delete=django.db.models.deletion.CASCADE, to='app.proveedor')),
            ],
            options={
                'verbose_name': 'compra',
