...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (formAgregar) {
        formAgregar.addEventListener("submit", function(e) {
            ...
            // Validar Proveedor
            var proveedor = formAgregar.querySelector("select[name='proveedor_id']");
            if (proveedor.value === "") {
            ...
            // Validar Producto
            var producto = formAgregar.querySelector("select[name='producto_id']");
            if (producto.value === "") {
    ...
    for (var j = 0; j < formsEditar.length; j++) {
        formsEditar[j].addEventListener("submit", function(e) {
            ...
            // Validar Proveedor
            var proveedor = formActual.querySelector("select[name='proveedor_id']");
            if (proveedor.value === "") {
                mostrarErrorCompra(proveedor, "Seleccione un proveedor.");
                valido = false;
            }
            ...
            // Validar Producto
            var producto = formActual.querySelector("select[name='producto_id']");
            if (producto.value === "") {
                mostrarErrorCompra(producto, "Seleccione un producto.");
                valido = false;
            }
